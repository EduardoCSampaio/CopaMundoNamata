...
function buildTeamSelectMenu() {
  ...
  allOption.innerHTML = `
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Transparent_square.svg/1200px-Transparent_square.svg.png" alt="Todas as seleções" />
  ...
  teams.forEach(team => {
    ...
    item.innerHTML = `
      <img src="${flags[team] || 'https://via.placeholder.com/28x20?text=?'}" alt="${team} flag">
      <span>${team}</span>
    `;
